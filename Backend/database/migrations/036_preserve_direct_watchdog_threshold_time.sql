-- Preserve the direct S-03 threshold crossing when watchdog evaluation runs late.
-- Group confirmation and recovery continue to use their existing transition time.
begin;
