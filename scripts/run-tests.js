...
const suites = Object.freeze({
  ...
  'simulate-grouped-lifecycle': {
    name: 'Open grouped process downtime (live)',
    description: 'Faults S-01, S-04, and S-02 one at a time, then leaves them active for recovery option 7.',
    expected: 'The third fault opens S-03 downtime; option 7 closes it.',
    simulation: true,
    commands: [npm('run', 'iot:simulate:verify-grouped-lifecycle')],
  },
  'simulate-direct-s03-lifecycle': {
    name: 'Open direct S-03 downtime (live)',
    description: 'Faults S-03, tests duplicate and stale events, then leaves it active for recovery option 7.',
    expected: 'S-03 opens downtime directly; option 7 closes it.',
    simulation: true,
